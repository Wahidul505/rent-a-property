      ...
      <form onSubmit={handleSubmitSale}>
        ...
        {loading ?
          <button className="btn btn-primary text-white font-semibold" disabled>
            <svg role="status" className="inline w-8 h-6 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-gray-600 dark:fill-gray-300" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          :
          <button type="submit" className="btn btn-primary text-white font-semibold">Submit</button>
        }
      </form>
    </div>
  )
