...
const SignUp = () => {
    ...
    const handleSignUp = async (e: React.FormEvent) => {
        ...
        if (!nameError && !emailError && !passwordError) {
            ...
            const res = await fetch('https://rent-a-property.onrender.com/sign-up', {
                headers: {
            ...
            if (data.status) {
                navigate('/login');
                toast.success('Please, Login with the created account', { id: 'signUp-success' });
            } else {
            ...
            <form onSubmit={(e) => handleSignUp(e)}>
                ...
                <div className="form-control">
                    ...
                    <input
                        ...
                        type="text" placeholder="name" className="input input-bordered text-lg" />
